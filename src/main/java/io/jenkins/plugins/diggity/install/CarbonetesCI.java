...
public class CarbonetesCI {
    ...
    public static void install(JenkinsConfig jenkinsConfig, DiggityConfig diggityConfig)
    ...
    public static void setPath(JenkinsConfig jenkinsConfig, DiggityConfig diggityConfig, String path)
